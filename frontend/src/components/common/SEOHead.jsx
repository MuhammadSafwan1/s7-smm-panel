...
export default function SEOHead({ 
  ...
  const defaultTitle = 'MSF SMM';
  const defaultDescription = 'MSF SMM Panel - World\'s #1 Most Trusted & Secure Premium SMM Panel founded by Muhammad Safwan. Global leader in social media marketing services for Instagram, YouTube, Facebook, TikTok, Twitter. 100% safe, instant delivery, 24/7 support, 50,000+ satisfied customers worldwide. Best SMM panel for followers, likes, views, comments, and subscribers at cheapest rates globally.';
  ...
  const defaultOgImage = siteLogo || 'https://msfsmm.com/og-image.png';
